...
public class AbnSearchWSHttpGet
{
	...
	public static ditr.abn.example.AbnSearchResult searchByABN(String guid, String abn, boolean includeHistorical) throws URISyntaxException, IOException,
			SAXException, ParserConfigurationException, FactoryConfigurationError
	{
		ditr.abn.example.AbnSearchResult results = null;
	...
	public static ditr.abn.example.AbnSearchResult searchByACN(String guid, String acn, boolean includeHistorical) throws URISyntaxException, IOException,
			SAXException, ParserConfigurationException, FactoryConfigurationError
	{
		ditr.abn.example.AbnSearchResult results = null;
	...
	public static ditr.abn.example.AbnSearchResult searchByABNv200506(String guid, String abn, boolean includeHistorical) throws URISyntaxException, IOException,
			SAXException, ParserConfigurationException, FactoryConfigurationError
	{
		ditr.abn.example.AbnSearchResult results = null;
	...
	public static ditr.abn.example.AbnSearchResult searchByACNv200506(String guid, String acn, boolean includeHistorical) throws URISyntaxException, IOException,
			SAXException, ParserConfigurationException, FactoryConfigurationError
	{
		ditr.abn.example.AbnSearchResult results = null;
	...
	public static ditr.abn.example.AbnSearchResult searchByNameSimpleProtocol(String guid, String name, boolean legal, boolean trading, boolean act, boolean nsw,
	...
	public static ditr.abn.example.AbnSearchResult searchByNameAdvancedSimpleProtocol(String guid, String name, boolean legal, boolean trading, boolean act,
	...
	private static ditr.abn.example.AbnSearchResult doRequest(String guid, String service, String parameters) throws URISyntaxException, IOException, SAXException,
			ParserConfigurationException, FactoryConfigurationError
	{
		...
		if (connection.getResponseCode() == HttpURLConnection.HTTP_OK)
			result = new ditr.abn.example.AbnSearchResult(XMLUtils.DOMParseXML(connection.getInputStream()).getDocumentElement());
